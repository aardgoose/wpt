...
test(t => {
  self.result = "Fail";
  let trusted_url = test_policy.createScriptURL("support/player.js");
...
test(t => {
  self.result = "Fail";
  let trusted_url = test_policy.createScriptURL("support/player.js?variant1");
  let trusted_url2 = test_policy.createScriptURL("support/player.js?variant2");
